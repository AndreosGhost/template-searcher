...
public interface IPineNode {
     ...
     * @return A new node.
     */
    IPineNode makeBoundNode(IPineNode parent, char parentChar);

    /**
     * Returns a new instance of the current implementation of the interface {@link
     * phoenix.templatesearcher.algo.IPineNode}.
     * @return
     */
    IPineNode makeNode();
     ...
     */
    void walkSubtree(IPineNodeVisitor<IPineNode> visitor);
